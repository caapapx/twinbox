...
function registerTwinboxTaskTools(api) {
  ...
  api.registerTool({
    ...
    description: "When the user has just replied in natural language at profile_setup (or similar stages), call this in the SAME turn: pass profile_notes and/or calibration_notes quoted from their message so the stage persists. Runs: twinbox openclaw onboarding-advance. After this tool returns, you MUST reply with a visible text summary (astron-code-latest often returns an empty bubble if you only call tools and print nothing).",
    parameters: Type.Object({
