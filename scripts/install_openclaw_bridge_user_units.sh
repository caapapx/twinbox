...
TWINBOX_CONFIG_DIR="${TWINBOX_POINTER_DIR:-${HOME}/.twinbox}"
ENV_FILE="${TWINBOX_CONFIG_DIR}/twinbox-openclaw-bridge.env"
SERVICE_SRC="${CODE_ROOT}/integrations/openclaw/twinbox-openclaw-bridge.service"
TIMER_SRC="${CODE_ROOT}/integrations/openclaw/twinbox-openclaw-bridge.timer"
