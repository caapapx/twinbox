...
| --- | --- |
| Accepted | 当前有效 |
| Superseded | 曾有效，已被另一 ADR/实现取代 |
| Proposed | 讨论中，未改 constitution |
...
| [ADR-004](./ADR-004-optional-weknora-retrieval-proposed.md) | Optional WeKnora retrieval | Accepted（开关仍关） |
